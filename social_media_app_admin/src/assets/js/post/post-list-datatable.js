$(document).ready(function () {
  $('#post-table').DataTable({
    ...
    ajax: {
      url: '/posts',
      type: 'GET',
      // request all records so DataTable handles client-side paging/sorting
      data: { limit: 100 },
      headers: {
      ...
      dataSrc: function (json) {
        ...
        // attach virtual counts that the service enriches on the data array
    ...
    // DataTable handles its own paging/length menu from the full dataset
    paging: true,
    lengthChange: true,
